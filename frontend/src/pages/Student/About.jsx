...
export default function About()
{
      ...
      <div className="row justify-content-center">
        <div className="col-lg-8" >
          <div className="hero-content text-center">
            ...
            >
              <a href="/Department" className="btn-primary">
                Get Started Today
              </a>
            ...
            >
              <div className="metric-item">
                ...
                <div className="metric-content">
                  ...
                  <span className="metric-label">Awards Won</span>
                </div>
              </div>
              <div className="metric-item">
                <div className="metric-icon">
        ...
        <div className="col-lg-5" >
          <div className="image-section">
            <div className="primary-image">
              <img
                src="assets/img/about/about-14.webp"
            ...
            <div className="image-grid">
              ...
              />
              <img
                src="assets/img/about/about-7.webp"
        ...
        <div className="col-lg-7" >
          <div className="content-section">
            <div className="section-intro">
              ...
              <h2>
                Building tomorrow's solutions with proven expertise and
                innovation
              </h2>
        ...
        <div className="row text-center">
          <div className="col-lg-3 col-md-6">
            <div className="metric-card">
              ...
              <div className="metric-label">Successful Projects</div>
            </div>
          </div>
          <div className="col-lg-3 col-md-6">
            <div className="metric-card">
          ...
          <div className="col-lg-3 col-md-6">
            <div className="metric-card">
              ...
              <div className="metric-label">Customer Support</div>
            </div>
          </div>
        </div>
      </div>
  ...
  <section id="features-2" className="features-2 section">
    <div className="container" >
      <div className="features-list row gy-4">
